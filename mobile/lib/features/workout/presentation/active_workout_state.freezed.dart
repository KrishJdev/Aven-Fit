...
mixin _$ActiveWorkoutState {
 ...
 WorkoutSession? get session; List<WorkoutSet> get sets; int get elapsedSeconds; bool get isRestTimerRunning; int get restTimerDurationSeconds; int get restTimerRemainingSeconds; bool get isSaving; String? get errorMessage;
...
int get hashCode {
  final _this = this as ActiveWorkoutState;
  return Object.hash(runtimeType,_this.session,const DeepCollectionEquality().hash(_this.sets),_this.elapsedSeconds,_this.isRestTimerRunning,_this.restTimerDurationSeconds,_this.restTimerRemainingSeconds,_this.isSaving,_this.errorMessage);
}

@override
String toString() {
  final _this = this as ActiveWorkoutState;
  return 'ActiveWorkoutState(session: ${_this.session}, sets: ${_this.sets}, elapsedSeconds: ${_this.elapsedSeconds}, isRestTimerRunning: ${_this.isRestTimerRunning}, restTimerDurationSeconds: ${_this.restTimerDurationSeconds}, restTimerRemainingSeconds: ${_this.restTimerRemainingSeconds}, isSaving: ${_this.isSaving}, errorMessage: ${_this.errorMessage})';
}
...
@useResult
$Res call({
 WorkoutSession? session, List<WorkoutSet> sets, int elapsedSeconds, bool isRestTimerRunning, int restTimerDurationSeconds, int restTimerRemainingSeconds, bool isSaving, String? errorMessage
});
...
/// Create a copy of ActiveWorkoutState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? session = freezed,Object? sets = null,Object? elapsedSeconds = null,Object? isRestTimerRunning = null,Object? restTimerDurationSeconds = null,Object? restTimerRemainingSeconds = null,Object? isSaving = null,Object? errorMessage = freezed,}) {
  return _then(ActiveWorkoutState(
session: freezed == session ? _self.session : session // ignore: cast_nullable_to_non_nullable
as WorkoutSession?,sets: null == sets ? _self.sets : sets // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( WorkoutSession? session,  List<WorkoutSet> sets,  int elapsedSeconds,  bool isRestTimerRunning,  int restTimerDurationSeconds,  int restTimerRemainingSeconds,  bool isSaving,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ActiveWorkoutState() when $default != null:
return $default(_that.session,_that.sets,_that.elapsedSeconds,_that.isRestTimerRunning,_that.restTimerDurationSeconds,_that.restTimerRemainingSeconds,_that.isSaving,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( WorkoutSession? session,  List<WorkoutSet> sets,  int elapsedSeconds,  bool isRestTimerRunning,  int restTimerDurationSeconds,  int restTimerRemainingSeconds,  bool isSaving,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _ActiveWorkoutState():
return $default(_that.session,_that.sets,_that.elapsedSeconds,_that.isRestTimerRunning,_that.restTimerDurationSeconds,_that.restTimerRemainingSeconds,_that.isSaving,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( WorkoutSession? session,  List<WorkoutSet> sets,  int elapsedSeconds,  bool isRestTimerRunning,  int restTimerDurationSeconds,  int restTimerRemainingSeconds,  bool isSaving,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _ActiveWorkoutState() when $default != null:
return $default(_that.session,_that.sets,_that.elapsedSeconds,_that.isRestTimerRunning,_that.restTimerDurationSeconds,_that.restTimerRemainingSeconds,_that.isSaving,_that.errorMessage);case _:
  return null;
...
class _ActiveWorkoutState extends ActiveWorkoutState {
  const _ActiveWorkoutState({required this.session,  List<WorkoutSet> sets = const <WorkoutSet>[], this.elapsedSeconds = 0, this.isRestTimerRunning = false, this.restTimerDurationSeconds = 90, this.restTimerRemainingSeconds = 0, this.isSaving = false, this.errorMessage}): _sets = sets,super._();
...
/// Create a copy of ActiveWorkoutState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? session = freezed,Object? sets = null,Object? elapsedSeconds = null,Object? isRestTimerRunning = null,Object? restTimerDurationSeconds = null,Object? restTimerRemainingSeconds = null,Object? isSaving = null,Object? errorMessage = freezed,}) {
  return _then(_ActiveWorkoutState(
session: freezed == session ? _self.session : session // ignore: cast_nullable_to_non_nullable
as WorkoutSession?,sets: null == sets ? _self._sets : sets // ignore: cast_nullable_to_non_nullable
as List<WorkoutSet>,elapsedSeconds: null == elapsedSeconds ? _self.elapsedSeconds : elapsedSeconds // ignore: cast_nullable_to_non_nullable
as int,isRestTimerRunning: null == isRestTimerRunning ? _self.isRestTimerRunning : isRestTimerRunning // ignore: cast_nullable_to_non_nullable
as bool,restTimerDurationSeconds: null == restTimerDurationSeconds ? _self.restTimerDurationSeconds : restTimerDurationSeconds // ignore: cast_nullable_to_non_nullable
as int,restTimerRemainingSeconds: null == restTimerRemainingSeconds ? _self.restTimerRemainingSeconds : restTimerRemainingSeconds // ignore: cast_nullable_to_non_nullable
